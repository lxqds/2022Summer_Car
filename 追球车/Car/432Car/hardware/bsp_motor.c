...
/**
 * @brief: 控制小车运动前进速度，后退速度等
 * @param {int16_t} Left_Speed
 * @param {int16_t} Right_Speed
 * @retval: 无
 */
void Car_Run(int16_t Left_Speed, int16_t Right_Speed)
{
	...
	motor_speed_all(3,Left_Speed);
	motor_speed_all(2,Right_Speed);
}
...
void Motor_right(void){
	motor_all_control(2,0);
	motor_all_control(3,1);
}
void Motor_left(void){
	motor_all_control(2,1);
