    ...
    bianmaqi[3]=0;
			...
			
		{
			case 1:
			{
					if(StopFlag == 0)
				{
					Turn = Turn_PD(XUNJIBias);
					K_A(Velocity_Mode1,Turn);
				
					Motor_A = PI_A(MotorA_speed[0],Target_A);
					Motor_B = PI_B(MotorA_speed[3],Target_B);
			...
			case 2:
			{
					if(StopFlag == 0)
				{
					Turn = Turn_PD2(XUNJIBias);
					K_A(Velocity_Mode2,Turn);
				
					Motor_A = PI_A2(MotorA_speed[0],Target_A);
					Motor_B = PI_B2(MotorA_speed[3],Target_B);
